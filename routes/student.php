...
Route::prefix('student')->name('student.')->middleware(['auth:student', 'verified', 'VerifyStudentStatus', 'redirectIfExpired'])->group(function () {
    Route::get('dashboard', [StudentController::class, 'index'])->name('dashboard');
    Route::get('educationalTool', [StudentController::class, 'educationalTool'])->name('educationalTool');
    Route::get('onlineSession', [StudentController::class, 'onlineSession'])->name('onlineSession');
